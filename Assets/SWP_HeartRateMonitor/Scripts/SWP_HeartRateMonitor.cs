...
public class SWP_HeartRateMonitor : MonoBehaviour
{
	...
	void Start()
	{
		...
		BlipOffset = new Vector3 (transform.position.x - (BlipMonitorWidth*Global.sizeModifier / 2), transform.position.y, transform.position.z);
		DisplayXEnd = BlipOffset.x + BlipMonitorWidth*Global.sizeModifier;
		CreateClone();
	...
	void Update()
	{
		...
		{			
			...
			NewClone.transform.position += new Vector3(BlipMonitorWidth*Global.sizeModifier * Time.deltaTime * LineSpeed, Random.Range(-0.05f, 0.05f), 0);
		else
		{
			NewClone.transform.position += new Vector3(BlipMonitorWidth*Global.sizeModifier * Time.deltaTime * LineSpeed, 0, 0);
	...
	IEnumerator PerformBlip()
	{
		...
		NewClone.transform.position = new Vector3(NewClone.transform.position.x, (10f * BlipMonitorHeightModifier*Global.sizeModifier) + Random.Range(0f, (2f * BlipMonitorHeightModifier*Global.sizeModifier)) + BlipOffset.y, BlipOffset.z);
		yield return new WaitForSeconds(0.03f);		
		NewClone.transform.position = new Vector3(NewClone.transform.position.x, (-5f * BlipMonitorHeightModifier*Global.sizeModifier) - Random.Range(0f, (3f * BlipMonitorHeightModifier*Global.sizeModifier)) + BlipOffset.y, BlipOffset.z);
		yield return new WaitForSeconds(0.02f);		
		NewClone.transform.position = new Vector3(NewClone.transform.position.x, (3f * BlipMonitorHeightModifier*Global.sizeModifier) + Random.Range(0f, (2f * BlipMonitorHeightModifier*Global.sizeModifier)) + BlipOffset.y, BlipOffset.z);
		yield return new WaitForSeconds(0.02f);		
		NewClone.transform.position = new Vector3(NewClone.transform.position.x, (2f * BlipMonitorHeightModifier*Global.sizeModifier) + Random.Range(0f, (1f * BlipMonitorHeightModifier*Global.sizeModifier)) + BlipOffset.y, BlipOffset.z);
		yield return new WaitForSeconds(0.02f);		
	...
	void CreateClone()
	{
		...
		NewClone.GetComponentInChildren<TrailRenderer>().startWidth = BlipTrailStartSize*Global.sizeModifier;
		NewClone.GetComponentInChildren<TrailRenderer>().endWidth = BlipTrailEndSize*Global.sizeModifier;
