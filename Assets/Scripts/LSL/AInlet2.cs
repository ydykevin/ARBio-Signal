...
{
	public abstract class AFloatInlet2 : MonoBehaviour
	{
		public enum UpdateMoment { FixedUpdate, Update }

		public UpdateMoment moment;

		public string StreamName = "GalvanicSkingResponse";
	...
	public abstract class ADoubleInlet2 : MonoBehaviour
	{
		public enum UpdateMoment { FixedUpdate, Update }
	...
	public abstract class ACharInlet2 : MonoBehaviour
	{
		public enum UpdateMoment { FixedUpdate, Update }
	...
	public abstract class AShortInlet2 : MonoBehaviour
	{
		public enum UpdateMoment { FixedUpdate, Update }
	...
	public abstract class AIntInlet2 : MonoBehaviour
	{
		public enum UpdateMoment { FixedUpdate, Update }
	...
	public abstract class AStringInlet2 : MonoBehaviour
	{
		public enum UpdateMoment { FixedUpdate, Update }
		...
		void Start()
		{
			...
			if (expectedStreamHasAName)
			{
				...
				resolver = new liblsl.ContinuousResolver("name", StreamName);
                Debug.Log(resolver==null?"null":"not null");
			}
			else if (expectedStreamHasAType)
			{
				Debug.Log("Creating LSL resolver for stream with type " + StreamType);
